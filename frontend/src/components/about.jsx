      ...
      <Container>
        <Grid container>
          ...
          <TextContainer>
            ...
            <Styledrole>Mechanical Engineer</Styledrole>
            <StyledIntro>
            As a motivated fourth-year mechanical engineering student, I am driven to apply my strong theoretical background
and practical skills to tackle complex engineering challenges, while actively contributing to a forward-thinking orga-
nization’s success and growth
            </StyledIntro>
            <IconContainer>
